...
Box2 = Frame(root, width = 300,height = 700,bg="red", relief=SUNKEN)
...
#labels
lblInfo = Label(Box, font=("arial",50),text="Sales",fg="red", bd=10, anchor="w")
...
btn7=Button(Box2,padx=16,pady=16,bd=8, fg="black", font=('arial',20),text="7",bg="red", command=lambda: btnClick(7)) .grid(row=2,column=0)
